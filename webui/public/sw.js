...
// Fetch event — network-first for everything, never cache hashed JS to prevent stale chunk errors
self.addEventListener('fetch', event => {
  ...
  // Assets and everything else — pass through to network (browser HTTP cache handles static assets)
  event.respondWith(
