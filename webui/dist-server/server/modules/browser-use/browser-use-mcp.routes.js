    ...
    try {
        ...
        switch (toolName) {
            ...
            case 'browser_fill_form':
                result = await browserUseService.agentFillForm(sessionId, Array.isArray(input.fields)
            ...
            case 'browser_select_option':
                result = await browserUseService.agentSelectOption(sessionId, String(input.selector || ''), Array.isArray(input.values) ? input.values.filter((value) => typeof value === 'string') : []);
                break;
...
//# sourceMappingURL=browser-use-mcp.routes.js.map