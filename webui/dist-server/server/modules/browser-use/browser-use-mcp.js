...
const jsonResponse = (value) => textResponse(JSON.stringify(value, null, 2));
...
async function callBrowserUseApi(toolName, input) {
    if (!apiToken) {
    ...
    switch (name) {
        ...
        case 'browser_select_option':
            return jsonResponse(await callBrowserUseApi(name, {
                ...
                values: Array.isArray(args.values) ? args.values.filter((value) => typeof value === 'string') : [],
            }));
...
//# sourceMappingURL=browser-use-mcp.js.map