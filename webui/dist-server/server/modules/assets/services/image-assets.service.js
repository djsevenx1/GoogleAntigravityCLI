...
export async function ensureImageAssetsDir() {
 ...
 */
export function buildStoredImageRecords(files) {
    const assetsDir = getGlobalImageAssetsDir();
 ...
 */
export function buildStoredAttachmentRecords(files) {
 ...
 */
export function resolveImageAssetFile(filename) {
 ...
 */
export function resolveAttachmentAssetFile(filename) {
 ...
 */
export async function openStoredAttachmentAsset(filename) {
...
//# sourceMappingURL=image-assets.service.js.map