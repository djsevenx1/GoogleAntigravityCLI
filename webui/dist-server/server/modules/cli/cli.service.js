...
function isNewerVersion(candidateVersion, currentVersion) {
    ...
    for (let partIndex = 0; partIndex < 3; partIndex += 1) {
        if (candidateParts[partIndex] > currentParts[partIndex])
            return true;
        if (candidateParts[partIndex] < currentParts[partIndex])
            return false;
    }
...
function showStatus(dependencies) {
...
function showHelp(dependencies) {
 ...
 */
export function createCliService(dependencies) {
