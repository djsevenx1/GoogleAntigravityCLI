...
import { createProject, deleteOrArchiveProject, restoreArchivedProject, } from '../../modules/projects/index.js';
...
const remove = (input) => removeWorktree(input, {
    runGit: runGitCommand,
    projects: worktreeProjects,
});
const create = (input) => createWorktree(input, {
    runGit: runGitCommand,
    fileSystem: worktreeFileSystem,
});
const open = (input) => openWorktreeAsProject(input, {
    runGit: runGitCommand,
    projects: worktreeProjects,
});
/**
...
//# sourceMappingURL=worktrees.module.js.map