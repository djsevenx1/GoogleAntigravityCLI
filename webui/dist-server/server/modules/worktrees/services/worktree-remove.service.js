 ...
 */
export async function removeWorktree(input, dependencies) {
    ...
    if (!input.force) {
        ...
        if (changedFileCount > 0) {
            throw new AppError(`Worktree has ${changedFileCount} uncommitted change${changedFileCount === 1 ? '' : 's'}`, {
                code: 'WORKTREE_DIRTY',
                statusCode: 409,
            });
        }
...
//# sourceMappingURL=worktree-remove.service.js.map