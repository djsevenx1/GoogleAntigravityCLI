...
const { sessionSynchronizerService } = await import('../../../modules/providers/services/session-synchronizer.service.js');
process.on('exit', () => {
...
function stubSlowProvider() {
    ...
    let releaseScan = () => { };
    const scanStarted = new Promise((resolveStarted) => {
        const fakeProvider = {
            id: 'claude',
            sessionSynchronizer: {
                async synchronize() {
...
//# sourceMappingURL=session-synchronizer-coalescing.test.js.map