...
test('getSessionDetailsById throws SESSION_NOT_FOUND for unknown ids', async () => {
    await withIsolatedDatabase(() => {
        assert.throws(() => sessionsService.getSessionDetailsById('does-not-exist'), (error) => error instanceof AppError && error.code === 'SESSION_NOT_FOUND');
    });
});
//# sourceMappingURL=sessions-details.test.js.map