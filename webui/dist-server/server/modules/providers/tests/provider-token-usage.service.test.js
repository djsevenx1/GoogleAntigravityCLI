...
import { createProviderTokenUsageService, summarizeClaudeTokenUsage, } from '../../../modules/providers/services/provider-token-usage.service.js';
...
test('token usage reports SESSION_NOT_FOUND for an unknown app session id', async () => {
    ...
    await assert.rejects(() => service.getSessionTokenUsage('missing-session'), (error) => (error instanceof AppError
...
function paddingLines(totalBytes) {
...
//# sourceMappingURL=provider-token-usage.service.test.js.map