...
export class OpenCodeProviderAuth {
    /**
    ...
    async checkCredentials() {
        try {
            ...
            for (const [providerId, providerAuth] of Object.entries(auth)) {
                ...
                const hasCredential = Object.values(providerRecord).some((value) => readOptionalString(value) !== undefined || Boolean(readObjectRecord(value)));
                if (hasCredential) {
                    return {
                        authenticated: true,
...
//# sourceMappingURL=opencode-auth.provider.js.map