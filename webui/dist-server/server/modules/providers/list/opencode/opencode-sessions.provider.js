...
import { createNormalizedMessage, generateMessageId, getOpenCodeDatabasePath, normalizeProviderTimestamp, readObjectRecord, readJsonRecord, readOptionalString, sliceTailPage, unwrapJsonStringLiteral, } from '../../../../shared/utils.js';
const PROVIDER = 'opencode';
const openOpenCodeDatabase = () => {
...
const readOpenCodeSessionColumnTokenUsage = (db, sessionId) => {
 ...
 */
const aggregateOpenCodeSessionTokenUsage = (db, sessionId) => {
...
export class OpenCodeSessionsProvider {
    /**
    ...
    normalizeHistoryRows(rows, sessionId) {
        const normalized = [];
        const emittedMessageErrors = new Set();
        for (const row of rows) {
...
//# sourceMappingURL=opencode-sessions.provider.js.map