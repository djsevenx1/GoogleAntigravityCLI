...
import { appendFilesInputTag, buildClaudeUserContent, normalizeImageDescriptors } from '../../../../shared/image-attachments.js';
import { CLAUDE_PREDEFINED_MODELS, CLAUDE_ULTRACODE_EFFORT } from '../../../../modules/providers/list/claude/claude-models.provider.js';
import { resolveClaudeCodeExecutablePath } from '../../../../shared/claude-cli-path.js';
import { createNotificationEvent, notifyBackgroundWorkCompleted, notifyRunFailed, notifyRunStopped, notifyUserIfEnabled } from '../../../../modules/notifications/index.js';
...
function mapCliOptionsToSDK(options = {}) {
    ...
    applyClaudeEffort(sdkOptions, resolveClaudeEffort(sdkOptions.model, effort, options.effortModels || CLAUDE_PREDEFINED_MODELS));
...
function addSession(sessionId, queryInstance, writer = null, releaseInput = null) {
    ...
    const superseding = Boolean(existing && existing.status === 'active' && existing.instance && existing.instance !== queryInstance);
    if (superseding) {
...
// Export public API
export { queryClaudeSDK, abortClaudeSDKSession, isClaudeSDKSessionActive, getActiveClaudeSDKSessions, resolveToolApproval, getPendingApprovalsForSession, reconnectSessionWriter, extractTokenBudget, extractCumulativeTokenBudget };
//# sourceMappingURL=claude-runtime.provider.js.map