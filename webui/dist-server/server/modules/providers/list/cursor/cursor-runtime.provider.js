...
async function spawnCursor(command, options = {}, ws, context) {
    ...
    return new Promise((resolve, reject) => {
        const { sessionId, projectPath, cwd, toolsSettings, skipPermissions, sessionSummary, images, files } = options;
        ...
        if ((command && command.trim()) || hasAttachments) {
            ...
            const promptWithAttachments = appendFilesInputTag(appendImagesInputTag(command || '', images), files);
...
//# sourceMappingURL=cursor-runtime.provider.js.map