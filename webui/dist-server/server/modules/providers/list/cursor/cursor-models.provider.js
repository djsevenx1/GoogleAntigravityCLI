...
import { buildDefaultProviderCurrentActiveModel, sanitizeLeafDirectoryName, } from '../../../../shared/utils.js';
/** Curated Cursor catalog shipped as immutable CloudCLI defaults. */
export const CURSOR_PREDEFINED_MODELS = {
    OPTIONS: [
...
const resolveCursorSessionStorePath = async (sessionId) => {
...
export class CursorProviderModels {
...
//# sourceMappingURL=cursor-models.provider.js.map