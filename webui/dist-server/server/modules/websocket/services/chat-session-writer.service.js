...
export class ChatSessionWriter {
    ...
    send(data) {
        ...
        if (message.kind === 'session_created') {
            const announcedId = typeof message.newSessionId === 'string' && message.newSessionId
    ...
    captureProviderSessionId(providerSessionId) {
...
//# sourceMappingURL=chat-session-writer.service.js.map