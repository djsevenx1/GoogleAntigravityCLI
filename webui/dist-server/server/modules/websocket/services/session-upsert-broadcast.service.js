 ...
 */
async function buildSessionUpsertedEvent(sessionIdOrProviderSessionId) {
...
function sendToConnectedClients(payloads) {
...
export async function broadcastSessionUpserted(sessionIdOrProviderSessionId) {
 ...
 */
export async function broadcastSessionUpsertedBatch(sessionIds) {
    const payloads = [];
...
//# sourceMappingURL=session-upsert-broadcast.service.js.map