      ...
      <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {t('tasks:createTaskModal.title', '创建 AI 智能任务')}
            </h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">
                  {t('tasks:createTaskModal.proTip', '提示：直接在对话中提出需求')}
                </h4>
                <p className="mb-3 text-sm text-blue-800 dark:text-blue-200">
                  {t('tasks:createTaskModal.description', '在对话中描述您的任务背景与需求，Agent 将自动为您拆解并生成可直接执行的任务。')}
                </p>
                <div className="rounded border border-blue-200 bg-white p-3 dark:border-blue-700 dark:bg-gray-800">
                  <p className="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">
                    {t('tasks:createTaskModal.exampleLabel', '示例：')}
                  </p>
                  <p className="font-mono text-sm text-gray-900 dark:text-white">
                    {t('tasks:createTaskModal.exampleContent', '“请添加一个头像上传功能任务，并包含最佳实践调研。”')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 pt-4 text-center dark:border-gray-700">
            ...
            >
              {t('tasks:createTaskModal.viewDocs', '查看任务功能文档')}
            </a>
          </div>
