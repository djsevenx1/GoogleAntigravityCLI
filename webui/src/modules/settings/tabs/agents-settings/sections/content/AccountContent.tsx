...
import AntigravityAccountManager from './AntigravityAccountManager';
...
const agentConfig: Record<AgentProvider, AgentVisualConfig> = {
  ...
  antigravity: {
    ...
    description: 'Google Antigravity CLI coding assistant',
    bgClass: 'bg-emerald-50 dark:bg-emerald-950/20',
    borderClass: 'border-emerald-200 dark:border-emerald-800',
    textClass: 'text-emerald-900 dark:text-emerald-100',
    subtextClass: 'text-emerald-700 dark:text-emerald-300',
    buttonClass: 'bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white',
  },
};

/** Rendered by AgentCategoryContentSection for the "account" category to show sign-in state for one provider. */
export default function AccountContent({ agent, authStatus, onLogin, onRefreshAuth, onNavigateToProxy }: AccountContentProps) {
