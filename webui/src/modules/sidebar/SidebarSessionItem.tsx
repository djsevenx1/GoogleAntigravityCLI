    ...
    <div className="group relative">
      ...
      <div>
        ...
        <Dialog open={isMobileOptionsOpen} onOpenChange={setMobileOptionsOpen}>
          ...
          >
            <DialogTitle>{t('sessions.optionsTitle', '会话选项')}</DialogTitle>
            ...
            <div className="mb-4 flex items-center gap-3 px-1">
              ...
              <div className="min-w-0">
                ...
                <p id="mobile-session-options-description" className="text-xs text-muted-foreground">
                  {providerLabel} {t('sessions.sessionSingle', '会话')}
                </p>
              </div>
            </div>
            ...
            {isEditing ? (
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium">{t('sessions.renameSession', '重命名会话')}</span>
                </button>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {copyState === 'error' && (
                      <span className="mt-0.5 block text-xs">{t('sessions.tapToRetry', '点击重试。')}</span>
                    )}
                  </span>
                </button>
                ...
                {!isProcessing && (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">{t('sessions.archiveOrDelete', '归档或删除会话')}</span>
                  </button>
                )}
              </div>
            )}
