        ...
        <div className="w-full max-w-[34.25rem]">
          ...
          <Dialog open={dialogOpen} onOpenChange={setPickerOpen}>
            ...
            <DialogContent className="max-w-md overflow-hidden p-0">
              <DialogTitle>{t("providerSelection.modelSelector", { defaultValue: "模型选择器" })}</DialogTitle>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground/70">
            {t("providerSelection.readyPrompt.antigravity", {
              model: providerModels.antigravity,
              defaultValue: "Ready with Google Antigravity {{model}}",
            })}
          </p>
