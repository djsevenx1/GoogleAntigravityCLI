    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-lg dark:border-gray-700/50 dark:bg-gray-800/90 dark:shadow-2xl">
        ...
        <div className="px-4 pb-2 pt-3.5">
          <div className="mb-1.5 flex items-center gap-2.5">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <span className="text-[10px] font-medium uppercase tracking-wide text-gray-400 dark:text-gray-500">
                {t('chat:interactive.needsInput', { defaultValue: 'Antigravity cli needs your input' })}
              </span>
              {q.header && (
          ...
          {multi && (
            <span className="text-[10px] text-gray-400 dark:text-gray-500">{t('chat:misc.selectAllThatApply', '可多选')}</span>
          )}
        </div>
